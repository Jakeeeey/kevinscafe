...
<div class="container mt-5">
    ...
    <div class="row" style="align-items: center; align-content: center;">
        ...
        <div class="col mt-5 mb-5">
            <a style="background-color: white; color: black; text-decoration: none; display: block; width: 300px; height: 150px; border: 3px solid; border-radius: 25px;" href="<?= base_url() . '/menulist'; ?>">
                <div style="float: left; text-align: center; margin-top: 45px; margin-left:30px;">
                    <h3><?= $menu_count; ?></h3>
                    <p class="h5">Menu List</p>
                </div>
        ...
        <div class="col mt-5 mb-5">
            <a style="background-color: white; color: black; text-decoration: none; display: block; width: 300px; height: 150px; border: 3px solid; border-radius: 25px;" href="<?= base_url() . '/category'; ?>">
                <div style="float: left; text-align: center; margin-top: 45px; margin-left:30px;">
    ...
    <div class="row text-center" style="align-items: center; align-content: center;  align-self: center;">

        <div class="col"></div>
        <div class="col">
            <a style="background-color: white; color: black; text-decoration: none; display: block; width: 300px; height: 150px; border: 3px solid; border-radius: 25px;" href="<?= base_url() . '/orders'; ?>">
                <div style="float: left; text-align: center; margin-top: 60px; margin-left:30px;">
                    <p class="h5">Orders</p>
                </div>
        ...
        <div class="col">
            <a style="background-color: white; color: black; text-decoration: none; display: block; width: 300px; height: 150px; border: 3px solid; border-radius: 25px;" href="<?= base_url() . '/sales1'; ?>">
                <div style="float: left; text-align: center; margin-top: 45px; margin-left:30px;">
                    <h3><?= $sales_count; ?></h3>
                    <p class="h5">Sales</p>
                </div>
