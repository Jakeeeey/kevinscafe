...
<div class="container mt-5 mb-5 p-5 bg-white">
    ...
    <div class="mb-3">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" href="<?= base_url() . '/purchases1'; ?>">Orders</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() . '/purchases1/cancelled'; ?>">Cancelled</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() . '/purchases1/completed'; ?>">Completed</a>
            </li>
        </ul>
    </div>
