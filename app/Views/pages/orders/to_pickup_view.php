...
<div class="container mt-5 mb-5 p-5 bg-white shadow border border-1">
    ...
    <div class="mb-3">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url().'/orders/preparing'; ?>">Preparing</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="<?= base_url().'/orders/to_pickup'; ?>">Ready for Pickup</a>
            </li>
            <li class="nav-item">
                ...
                <tr>
                    ...
                    <td class="order-status-row">
                        <select class="form-select" name="order-status" id="order-status" class="order-status"
                            ...
                            <?php elseif ($order['order_status'] == 'to_pickup') : ?>
